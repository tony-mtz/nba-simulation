...
#        print(f"shot made?:{shot} from {self.zones_list[pickLocation]}")
    ...
    def loadPlayer(self, playerID):
        ...
        for i,j,k in zip(df.SHOT_ZONE_RANGE,df.SHOT_ZONE_AREA, df.SHOT_MADE_FLAG):
            if i == zones_list[0][0] and j == zones_list[0][1]:
                stats[0][1] +=1
                if k:
                    stats[0][0] +=1  
            
            if i == zones_list[1][0] and j == zones_list[1][1]:
                stats[1][1] +=1
                if k:
                    stats[1][0] +=1 
                    
            if i == zones_list[2][0] and j == zones_list[2][1]:
                stats[2][1] +=1
                if k:
                    stats[2][0] +=1 
            
            if i == zones_list[3][0] and j == zones_list[3][1]:
                stats[3][1] +=1
                if k:
                    stats[3][0] +=1 
                    
            if i == zones_list[4][0] and j == zones_list[4][1]:
                stats[4][1] +=1
                if k:
                    stats[4][0] +=1 
                    
            if i == zones_list[5][0] and j == zones_list[5][1]:
                stats[5][1] +=1
                if k:
                    stats[5][0] +=1 
                    
            if i == zones_list[6][0] and j == zones_list[6][1]:
                stats[6][1] +=1
                if k:
                    stats[6][0] +=1 
                    
            if i == zones_list[7][0] and j == zones_list[7][1]:
                stats[7][1] +=1
                if k:
                    stats[7][0] +=1 
                    
            if i == zones_list[8][0] and j == zones_list[8][1]:
                stats[8][1] +=1
                if k:
                    stats[8][0] +=1 
                    
            if i == zones_list[9][0] and j == zones_list[9][1]:
                stats[9][1] +=1
                if k:
                    stats[9][0] +=1 
            
            if i == zones_list[10][0] and j == zones_list[10][1]:
                stats[10][1] +=1
                if k:
                    stats[10][0] +=1  
            
            if i == zones_list[11][0] and j == zones_list[11][1]:
                stats[11][1] +=1
                if k:
                    stats[11][0] +=1 
                    
            if i == zones_list[12][0] and j == zones_list[12][1]:
                stats[12][1] +=1
                if k:
                    stats[12][0] +=1 
            
            if i == zones_list[13][0] and j == zones_list[13][1]:
                stats[13][1] +=1
                if k:
                    stats[13][0] +=1 
                    
            if i == zones_list[14][0] and j == zones_list[14][1]:
                stats[14][1] +=1
                if k:
                    stats[14][0] +=1 
        #            
